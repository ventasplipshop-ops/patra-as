...
type Vista = "caja" | "deposito" | "dashboard" | "inventario" | "leads" | "orders" | "fotolab" | "folletos" | "transferencias" | "videolab";
        ...
        <>
          ...
          >
            ...
            <nav className="mt-2 space-y-1" aria-label="Herramientas de impresión">
              {([['fotolab', 'FotoLab'], ['folletos', 'Folletos'], ['transferencias', 'Transferencias'], ['videolab', 'VideoLab']] as const).map(([vista, label]) => (
